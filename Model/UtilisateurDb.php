...
class UtilisateurDb extends Modele {
    ...
    public function getIdUtilisateur ($pseudo, $mdp) {
		...
		$resultat = $this->executerRequete($sql, array($pseudo, cryptage($mdp)));
	...
	public function updateIdentUtilisateur ($id, $pseudo, $mdp) {
		$sql = "UPDATE utilisateurdb SET Pseudo = ?, Mdp = ? WHERE id = ?";	
		$this->executerRequete($sql, array($pseudo, cryptage($mdp), $id);
	}
	...
	public function ajoutUtilisateur ($nom, $prenom, $speudo, $adresseMail, $telephone, $mdp, $numRue, $idRue, $idVille, $idPays, $cp, $commentAdrs) {
		...
		$this->executerRequete($sql, array($nom, $prenom, $speudo, $adresseMail, $telephone, cryptage($mdp), $numRue, $idRue, $idVille, $idPays, $cp, $commentAdrs));
	}
	...
	public function modifUtilisateur ($id, $nom, $prenom, $speudo, $adresseMail, $telephone, $mdp, $numRue, $idRue, $idVille, $idPays, $cp, $commentAdrs) {
		...
		$this->executerRequete($sql, array($nom, $prenom, $speudo, $adresseMail, $telephone, cryptage($mdp), $numRue, $idRue, $idVille, $idPays, $cp, $commentAdrs, $id));
	}
